...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(5, 31, 111, 0.92) 0%, rgba(113, 196, 255, 0.34) 100%)';
...
const ProfileCardComponent = ({
    ...
    }, [enableTilt, enableMobileTilt, handleDeviceOrientation, handlePointerEnter, handlePointerLeave, handlePointerMove, tiltEngine]);
                                ...
                                <div className="pc-user-info">
                                    <div className="pc-user-details">
                                        <div className="pc-mini-avatar">
                                            <img src={miniAvatarUrl || avatarUrl} alt={`${name} mini portrait`} loading="lazy" />
                                        </div>
